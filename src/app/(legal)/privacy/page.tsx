  ...
  return (
    <main className='flex max-w-[80ch] flex-col gap-8'>
      ...
      <section className='flex flex-col gap-4'>
        <h2 className='text-xl'>1. An overview of data protection</h2>
        ...
        <div className='flex flex-col gap-2'>
          <h3 className='text-lg'>Data recording on this website</h3>
          <div>
            <h4>
      ...
      <section className='flex flex-col gap-4'>
        ...
        <div className='flex flex-col gap-2'>
          <h3 className='text-lg'>Vercel</h3>
          <p className='font-light'>
            The provider is Vercel Inc., 440 N Barranca Ave #4133, Covina, CA
            91723 (hereinafter referred to as &ldquo;Vercel&rdquo;).
          </p>
          <p className='font-light'>
            When you visit our website, your personal data will be processed on
            Vercel servers. This may also result in the transfer of personal
            data to Vercel servers in the United States. The transfer of data to
            the US is based on the EU&rsquo;s standard contractual clauses. For
          ...
          <p>
            For more information, please see the Vercel Data Privacy Policy:{' '}
            <a
          ...
          <p>
            Vercel is used on the basis of Art. 6(1)(f) GDPR. We have a
            ...
            storage of cookies or the access to information in the user&rsquo;s
        ...
        <div className='flex flex-col gap-2'>
          <h3 className='text-lg'>Cloudflare</h3>
          <p className='font-light'>
          ...
          <p className='font-light'>
            ...
            traffic from the Internet. In this context, Cloudflare may also use
            cookies or other technologies deployed to recognize Internet users,
          ...
          <p className='font-light'>
            ...
            provision of our website offerings that is as error free and secure
      ...
      <section className='flex flex-col gap-4'>
        ...
        <div className='flex flex-col gap-2'>
          <h3 className='text-lg'>Data protection</h3>
          <p className='font-light'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <p className='font-light'>Moritz Schüßler</p>
          <p className='font-light'>E-mail: contact@moritzschuessler.de</p>
          <p className='font-light'>
        ...
        <div className='flex flex-col gap-2'>
          <h3 className='text-lg'>Recipients of personal data</h3>
          <p className='font-light'>
        ...
        <div className='flex flex-col gap-2'>
          <h3 className='text-lg'>Right to demand processing restrictions</h3>
          <p className='font-light'>
        ...
        <div className='flex flex-col gap-2'>
          <h3 className='text-lg'>SSL and/or TLS encryption</h3>
      ...
      <section className='flex flex-col gap-4'>
        <h2 className='text-xl'>4. Recording of data on this website</h2>
        <div className='flex flex-col gap-2'>
          ...
          <p className='font-light'>
            ...
            (Art. 6(1)(a) GDPR and &sect; 25 (1) TTDSG); this consent may be
            revoked at any time.
          </p>
          <p className='font-light'>
